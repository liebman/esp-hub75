...
impl<DM: esp_hal::DriverMode, FB: crate::framebuffer::FrameBuffer + 'static> Hub75<DM, FB> {
    ...
    >(
        ...
        // SAFETY: The PARL_IO peripheral is already owned by the driver
        // constructed above. We `steal()` a PAC handle solely to set the
        // `tx_eof_gen_sel` bit so the DMA EOF signal is generated by the
