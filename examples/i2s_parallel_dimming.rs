...
//! the I2S peripheral of an `esp32` using a delay as a brightness control.
//!
...
//! rate and render rate plus the curent brightnes value. The brightness value
//! is ramped between 1 and 255 and back to 1.
//!
